...
const navItems = [
  ...
  },
  {
    href: "/admin/coupons",
    label: "Coupons",
    match: (p: string) => p === "/admin/coupons" || p.startsWith("/admin/coupons"),
  },
  {
    href: "/admin/box-rules",
    label: "Shipping Box Rules",
    match: (p: string) => p === "/admin/box-rules" || p.startsWith("/admin/box-rules"),
  },
  {
    href: "/admin/store-addresses",
    label: "Store Addresses",
    match: (p: string) => p === "/admin/store-addresses" || p.startsWith("/admin/store-addresses"),
  },
  {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {(label === "Rates" || label === "Shipping Box Rules") && (
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {label === "Store Addresses" && (
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21h18M5 21V8l7-4 7 4v13M9 21v-6h6v6M9 10h.01M12 10h.01M15 10h.01" />
                    </svg>
                  )}
                  {label === "Settings" && (
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.572c1.756.427 1.756 2.925 0 3.352a1.724 1.724 0 00-1.066 2.572c.94 1.543-.827 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.066c-.427 1.756-2.925 1.756-3.352 0a1.724 1.724 0 00-2.572-1.066c-1.543.94-3.31-.827-2.37-2.37a1.724 1.724 0 00-1.066-2.572c-1.756-.427-1.756-2.925 0-3.352a1.724 1.724 0 001.066-2.572c-.94-1.543.827-3.31 2.37-2.37.996.608 2.296.07 2.572-1.066z" />
